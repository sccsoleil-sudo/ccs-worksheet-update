"""Shared mappings and customer groups for CCS worksheet updates."""
...
# Brand/Axe mapping with Div cross-check (acronym = first 4 chars of Item Text)
BRAND_AXE_MAPPING = [
...
# CPD customer → sheet name (same groups for new lines & discrepancies)
CPD_CUSTOMER_GROUPS = {
    "LCL": {"10118351"},
    "SDM": {"10118010"},
    "AMZ": {"10118507"},
...
NON_CPD_DIVS = ["LDB", "LPD", "PPD"]
AMOUNT_COL = "Amount (CoCode Crcy)"
